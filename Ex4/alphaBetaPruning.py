...
def abmax(gm, d, a, b):
    # print("now calculate abmax") print("d=",d)  # the depth of the recursion (כמה צדדים רואים קדימה) print(
    # "alpha=",a)  # alpha and beta are representing respectively the minimum and the maximum score that the player
    # can be assured. print("beta=",b)
